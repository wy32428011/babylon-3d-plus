...
`;e.ShadersStore[G]||(e.ShadersStore[G]=K);var q=[m,A,R,h,g,F,O,M,d,N,t,n,o,T,E,P,V,f,_,v,y,i,a,b,s,c,l,u,r,k,D,j,W,p,x,S,w,C];for(let t of q)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var J={name:G,shader:K};export{J as t};