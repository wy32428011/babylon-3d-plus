import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as n}from"./clusteredLightingFunctions-DNqaoQCj.js";var r=`lightProxyVertexShader`,i=`attribute position: vec3f;flat varying vOffset: u32;flat varying vMask: u32;
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=i);var a=[t,n];for(let t of a)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var o={name:r,shader:i};export{o as t};