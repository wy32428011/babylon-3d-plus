import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`tonemapPixelShader`,n=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform _ExposureAdjustment: f32;
...
#endif
fragmentOutputs.color= vec4f(colour.rgb,1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);var r={name:t,shader:n};export{r as t};