...
`;e.ShadersStore[S]||(e.ShadersStore[S]=C);var w=[t,n,i,a,o,v,p,x,d,m,s,c,l,u,r,f,h];for(let t of w)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var T={name:S,shader:C};export{T as t};