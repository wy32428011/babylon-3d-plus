import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`tonemapPixelShader`,n=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float _ExposureAdjustment;
...
#endif
gl_FragColor=vec4(colour.rgb,1.0);}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as t};