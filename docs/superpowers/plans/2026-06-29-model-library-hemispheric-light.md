...
- [x] **Step 1: 删除 Toolbar 半球光图标映射和 prop**
...
- [x] **Step 1: 更新模型库内置资源描述**

将五类内置资源改为六类：立方体、球体、地面、半球光、方向光、点光源。

- [x] **Step 2: 删除 Toolbar 半球光操作说明**
