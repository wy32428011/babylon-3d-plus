...
`Shelf.glb` 不允许修改；源包、资产副本和视觉夹具的 GLB 哈希必须一致。本轮已同步 `F:\3d-models\models\Shelf`、`F:\3d-models\models\Assets\Models\Shelf` 与 `output/playwright/shelf-assets` 的 `shelf.model.ts` / `meta.json`，并同步 `output/playwright/shelf-assets/shelf.model.txt` 供浏览器夹具加载。
