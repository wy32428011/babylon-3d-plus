...
export const SKYBOX_SPHERE_SEGMENTS = 48;
/** 保守取一个经纬网格角步长，确保相机位于 Babylon 天空盒所有三角面内侧。 */
export const SKYBOX_SPHERE_INNER_RADIUS_RATIO = Math.cos(
  Math.PI / (SKYBOX_SPHERE_SEGMENTS + 2),
);
