...
export type DataPlatformModelSyncPhase = 'querying' | 'downloading' | 'validating' | 'promoting' | 'completed' | 'failed';
...
/** Web 部署工程导出的执行阶段。 */
export type DeploymentExportPhase = 'preflight' | 'copy-template' | 'copy-assets' | 'write-metadata' | 'archive' | 'publish';
